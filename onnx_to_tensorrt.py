...
def main():
    ...
    output_shapes_480 = [(batch_size, 255, 15, 15), (batch_size, 255, 30, 30)]
    output_shapes_544 = [(batch_size, 255, 17, 17), (batch_size, 255, 34, 34)]
    output_shapes_608 = [(batch_size, 255, 19, 19), (batch_size, 255, 38, 38)]
    output_shapes_dic = {'416': output_shapes_416, '480': output_shapes_480, '544': output_shapes_544,
    ...
    trt_outputs = []
    index = 0
    with get_engine(onnx_file_path, batch_size, fp16_on,
        ...
        for filename in filenames:
            ...
            print("inference time spent:", inference_time)
            ...
            yolo_anchors = [[(116, 90), (156, 198), (373, 326)],
                            ...
                            [(10, 13),  (16, 30),   (33, 23)]]
            write = 0
            output_shapeses = [(1, 255, 19, 19), (1, 255, 38, 38), (1, 255, 76, 76)]
            yolo_start = time.time()
            for output, shape, anchors in zip(trt_outputs, output_shapeses, yolo_anchors):
            ...
            print(f'yolo time is {yolo_time}')
